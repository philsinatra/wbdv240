...
<!-- 	<script>
		...
		function days_in_quarter() {
			...
			var today        = new Date();
			var startDate    = new Date(2014,09,23); //year,month,day of first class session (month - 1; jan = 0)
			var endDate      = new Date(2014,12,31); //year,month,day of last class session (month - 1; jan = 0)
