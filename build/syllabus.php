	...
	<div id="layout" class="pure-g-r">
		...
		<div class="pure-u" id="main">
			...
			<div class="content">
				...
				<h2 class="content-subhead">Final Project</h2>				
					...
					<dl> 
						...
						<dd> 
							...
							<ul>
								<li>Does everything look the same? </li>
								<li>Has the design changed? </li>
								<li>If it did, why? </li>
							</ul>
							<p>
				...
				<p>
					Students are allowed one unexcused absence. If a student has more than one unexcused absence, his or her grade for the course will be reduced one letter grade. If a student has three absences, he or she will receive an F grade.
				</p>
				<p>
				...
				<ul>
					<li> Files/e-mails are named appropriately
						<ul>
							<li>Assignments requiring email submission should be sent to your instructor using the following format for the subject of the email: <b>wbdv240-hwk##-jhs123</b>. Replace ## with the term week number, and replace jhs123 with your email prefix. Submissions not following this format will not filter properly and not accepted. No exceptions.</li>
						</ul>
				...
				<h2 class="content-subhead">Attendance Policy</h2>				
				<p>
